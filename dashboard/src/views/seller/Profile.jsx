                            ...
                            { !userInfo?.shopInfo ? 
                                <form onSubmit={add}>
                                    ...
                                    <div className='flex flex-col w-full gap-1 mb-2'>
                                        ...
                                        <input value={state.sub_district} onChange={inputHandle} className='px-4 py-2 focus:border-indigo-200 outline-none bg-[#6a5fdf] border border-slate-700 rounded-md text-[#d0d2d6]' type="text" name='sub' id='sub' placeholder='Sub District Name' />
                                    </div>  
