...
import { get_customer_message, get_customers, messages, currentCustomer } from '../../store/Reducers/chatReducer';
                ...
                <div className="flex w-full h-full relative">
                    ...
                    >
                        <div className="w-full h-[calc(100vh-177px)] bg-[#9e97e9] md:bg-transparent overflow-y-auto">
                            ...
                            { customers.map((c,i) => 
                                <Link key={i} to={`/seller/dashboard/chat-customer/${c.friendId}`} className={`h-[60px] flex justify-start gap-2 items-center text-white px-2 py-2 rounded-md cursor-pointer bg-[#8288ed] `}>
