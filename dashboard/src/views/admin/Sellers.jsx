                    ...
                    <table className="w-full text-sm text-left text-[#d0d2d6]">
                        ...
                        {[1, 2, 3, 4, 5].map((d, i) => (
                            <tr key={i}>
                                ...
                                <td scope="row" className="py-1 px-4 font-medium whitespace-nowrap">S M HEMEL{" "}</td>
                                <td scope="row" className="py-1 px-4 font-medium whitespace-nowrap">BlinkBasket</td>
                                <td scope="row" className="py-1 px-4 font-medium whitespace-nowrap">
                                    <span>Pending</span>{" "}
                                </td>
                                <td scope="row" className="py-1 px-4 font-medium whitespace-nowrap">seller@gmail.com</td>
                                <td scope="row" className="py-1 px-4 font-medium whitespace-nowrap">Dhaka</td>
                                <td scope="row" className="py-1 px-4 font-medium whitespace-nowrap">Dhanmondi</td>
                                <td scope="row" className="py-1 px-4 font-medium whitespace-nowrap">
