                        ...
                        <tbody>
                            {
                                [1,2,3,4,5].map((d, i) => (
                                    <tr className='border-b border-slate-700' key={i}>
                                        ...
                                        <td scope='row' className='py-2 px-4 font-medium whitespace-nowrap'>Kazi Ariyan </td>
                                        <td scope='row' className='py-2 px-4 font-medium whitespace-nowrap'>ariyan@gmail.com</td>
